...
const vectors: any[] = [
  ...
  {
    hash: SHA1,
    ikm: Buffer.from('0b0b0b0b0b0b0b0b0b0b0b', 'hex'),
    salt: Buffer.from('000102030405060708090a0b0c', 'hex'),
    info: Buffer.from('f0f1f2f3f4f5f6f7f8f9', 'hex'),
    len: 42,
    prk: Buffer.from('9b6c18c432a7bf8f0e71c8eb88f4b30baa2ba243', 'hex'),
    okm: Buffer.from(
      '' +
  ...
  },
  {
    ...
    len: 82,
    prk: Buffer.from('8adae09a2a307059478d309b26c4115a224cfaf6', 'hex'),
    okm: Buffer.from(
      '' +
  ...
  },
  {
    ...
    info: null,
    len: 42,
    prk: Buffer.from('da8c8a73c7fa77288ec6f5e7c297786aa0d32d01', 'hex'),
    okm: Buffer.from(
      '' +
  ...
  {
    hash: SHA1,
    ikm: Buffer.from('0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c0c', 'hex'),
    salt: null, // Defaults to HashLen zero bytes.
    info: null,
    len: 42,
    prk: Buffer.from('2adccada18779e7c2077ad2eb19d3f3e731385dd', 'hex'),
    okm: Buffer.from(
      '' +
