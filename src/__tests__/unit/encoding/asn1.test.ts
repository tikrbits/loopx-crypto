...
describe('ASN1', function () {
    ...
    it(`should serialize int: ${num}`, () => {
      {
        ...
        const n2 = asn1.Integer.decodeBody<asn1.Integer>(data);
...

      {
        ...
        const n2 = asn1.Integer.decode<asn1.Integer>(n1.encode());
        assert.strictEqual(n2.toNumber(), n1.toNumber());
        assert.strictEqual(n2.toNumber(), num);
      }
    });
  ...
  it('should handle bit string', () => {
    ...
    const r = asn1.BitString.decode<asn1.BitString>(bs.encode());
  ...
  it('should handle UTC time', () => {
    ...
    const r = asn1.UTCTime.decode<asn1.UTCTime>(time.encode());
    ...
    const r2 = asn1.UTCTime.decode<asn1.UTCTime>(r.encode());
  ...
  it('should handle GEN time', () => {
    ...
    const r = asn1.GenTime.decode<asn1.GenTime>(time.encode());
    ...
    const r2 = asn1.GenTime.decode<asn1.GenTime>(r.encode());
