...
const gkey = Buffer.from(
  '3a0c0bf669694ac7685e6806eeadee8e56c9b9bd22c3caa81c718ed4bbf809a1',
  'hex',
);

const giv = Buffer.from('6dd26d9045b73c377a9ed2ffeca72ffd', 'hex');
...
describe('AES', function () {
  it('should encrypt and decrypt with 2 blocks', () => {
    ...
    const ciphertext = aes.encipher(data, gkey, giv);
    assert.bufferEqual(ciphertext, expected);

    const plaintext = aes.decipher(ciphertext, gkey, giv);
