...
export namespace x509 {
  ...
  export class AlgorithmIdentifier extends asn1.Sequence {
    ...
    constructor(
      algorithm?: number | number[] | Buffer | Uint32Array | string,
  ...
  export class RDN extends asn1.Set {
    ...
    constructor(
      id?: string | number | number[] | Buffer | Uint32Array,
      value?: asn1.Node,
    ) {
      super();
    ...
    readBody(br: BufferReader) {
      ...
      while (br.left()) {
        const attr = Attribute.read<Attribute>(br);
  ...
  export class Extensions extends asn1.Sequence {
    ...
    readBody(br: BufferReader) {
      // fixed by ty: read extensions from buffer
      while (br.left()) {
        const ext = <Extension>Extension.read(br);
  ...
  export class Extension extends asn1.Sequence {
    ...
    clean() {
      return (
        this.extnID.clean() && this.critical.clean() && this.extnValue.clean()
      );
    }
